...
public class Tree {
	...
	public void insert(Card card) {
		if(isFull()) {
			...
			TreeNode temp = new TreeNode(card);
			if(isEmpty()) {
				root = temp;
			}else {
				...
				while(true) {
					...
					if(current.getData().isGreaterThan(card)) {
	...
	//TODO: implement insert(Card) as a recursive method
...
//		if(current.getRight()!=null) {
	...
	public void displayInOrder(TreeNode current) {
